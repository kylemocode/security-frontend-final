	...
	return (
		<div className={props.className}>
			<div>
				...
				<p className="content__body"><span className="content__subtitle">Name:  </span>{props.data[0].file_path.split('/').slice(-1)[0]}</p>
				<p className="content__body"><span className="content__subtitle">File version:  </span>{props.data[0].file_version}</p>
				<p className="content__body"><span className="content__subtitle">Prod version:  </span>{props.data[0].prod_version}</p>
				<p className="content__body"><span className="content__subtitle">Entropy:  </span>{props.data[0].entropy}</p>
			</div>
			<div>
				<p className="content__title">Basic Properties</p>
				<p className="content__body"><span className="content__subtitle">File size:  </span>{Math.round(props.data[0].file_size/100000)} MB ({props.data[0].file_size} Bytes)</p>
				<p className="content__body"><span className="content__subtitle">SHA1:  </span>{props.data[0].file_hash_sha1}</p>
				<p className="content__body"><span className="content__subtitle">Magic:  </span>{props.data[0].file_magic}</p>
				<p className="content__body"><span className="content__subtitle">State:  </span>{props.data[0].file_state}</p>
			</div>
			<div className="content__margin">
				<p className="content__title">History</p>
				<p className="content__body"><span className="content__subtitle">Created time:  </span>{props.data[0].create_time}</p>
				<p className="content__body"><span className="content__subtitle">Modified time:  </span>{props.data[0].modified_time}</p>
			...
			<div className="content__margin">
				...
				<p className="content__body width_controller">{props.data[0].counter_signer}</p>
			</div>
			<div className="content__margin">
