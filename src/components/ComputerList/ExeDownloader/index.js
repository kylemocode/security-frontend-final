...
const ExeDownloader = () => {
    return (
        <ExeContainer>
            ...
            <div style={{flex:'2'}}>
                <img src="https://s3-ap-northeast-1.amazonaws.com/www.memepr.com/smartQA/undraw_download_pc33.svg" style={{width:'200px',height:'210px',position:'absolute',bottom:'5px',right:'2px'}}/>
            </div>
        </ExeContainer>
    )
}
